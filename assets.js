...
window.TASK_ASSETS = {
  ...
  "3.1.1": [localAsset("3.1.1", "3.1.1.docx", "docx", "原题答题卷 3.1.1.docx"), localAsset("3.1.1", "智能音箱数据集.xlsx", "xlsx", "素材数据 Excel"), localAsset("3.1.1", "参考答案-3.1.1.xlsx", "xlsx", "参考工作簿 3.1.1.xlsx")],
  "3.1.2": [localAsset("3.1.2", "3.1.2.docx", "docx", "原题答题卷 3.1.2.docx"), localAsset("3.1.2", "智能照明系统数据集.xlsx", "xlsx", "素材数据 Excel"), localAsset("3.1.2", "参考答案-3.1.2.xlsx", "xlsx", "参考工作簿 3.1.2.xlsx")],
  "3.1.3": [localAsset("3.1.3", "3.1.3.docx", "docx", "原题答题卷 3.1.3.docx"), localAsset("3.1.3", "智能健康手环数据集.xlsx", "xlsx", "素材数据 Excel"), localAsset("3.1.3", "参考答案-3.1.3.xlsx", "xlsx", "参考工作簿 3.1.3.xlsx")],
  "3.1.4": [localAsset("3.1.4", "3.1.4.docx", "docx", "原题答题卷 3.1.4.docx"), localAsset("3.1.4", "智能健康监测系统数据集.xlsx", "xlsx", "素材数据 Excel"), localAsset("3.1.4", "参考答案-3.1.4.xlsx", "xlsx", "参考工作簿 3.1.4.xlsx")],
  "3.1.5": [localAsset("3.1.5", "3.1.5.docx", "docx", "原题答题卷 3.1.5.docx"), localAsset("3.1.5", "智能家居环境控制系统数据集.xlsx", "xlsx", "素材数据 Excel"), localAsset("3.1.5", "参考答案-3.1.5.xlsx", "xlsx", "参考工作簿 3.1.5.xlsx")],
